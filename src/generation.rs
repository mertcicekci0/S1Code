...
pub fn proposal_schema() -> Value {
    ...
    let variants = vec![
        ...
        object(
            json!({"type":{"type":"string","enum":["replace"]},"path":str_,"before_hash":str_,"old":str_,"new":str_}),
        ),
        object(
